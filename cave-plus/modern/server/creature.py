...
CREATURE_DATA = {
    ...
    18: ("", "B50010020040010006H040"),  # Unnamed
    19: ("Maggot", "B20020005085010006H060"),
    20: ("", "B10000505005002002H030"),  # Unnamed
...
INITIAL_CREATURE_PLACEMENT = {
    ...
    39: [(21, 34)],  # Author
    46: [(24, 38)],  # Killer
    55: [(35, 65535)],  # Goblin (bugged stamina)
    63: [(32, 48), (33, 60)],  # Toad, Unnamed
    67: [(23, 49)],  # Coward
    83: [(42, 100)],  # Caveman
    3: [(36, 50)],  # Unnamed
    14: [(40, 80)],  # Unnamed
