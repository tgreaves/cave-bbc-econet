...
The game is feature-complete with authentic BBC Micro behavior, real-time multiplayer, combat, creatures, and original MODE 7 graphics!
...
python scripts/player_data_tool.py show cave-plus/modern/player_data/PLAYERNAME.json

# Set player score (rank calculated automatically)
python scripts/player_data_tool.py set-score cave-plus/modern/player_data/PLAYERNAME.json 1000

# Set player room
python scripts/player_data_tool.py set-room cave-plus/modern/player_data/PLAYERNAME.json 16

# Fix checksum and clean up file
python scripts/player_data_tool.py fix-checksum cave-plus/modern/player_data/PLAYERNAME.json
```
